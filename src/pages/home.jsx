...
function Home() {
  return (
    ...
    <nav className="flex flex-wrap lg:justify-between sm:item-center bg-gray-100  lg:p-3">
        <img className="w-10 h-5 lg:w-24 m-1 lg:h-6 mt-3 lg:ms-20 rounded" src="/asessts/Logo.png" alt="Logo" />
    ...
    <section className="flex p-10 m-10 lg:mx-20 border shadow-lg rounded-3xl">
        ...
        <p className="text-red-500 lg:px-10 lg:mx-10  text-xs lg:text-lg ">BEST DESTINATION AROUND THE WORLD</p>
        ...
        <p className="px-0 lg:px-10 text-xs lg:text-lg lg:mx-10 mx-0 my-4" >Build wicket longer more admiredo bartan vanity itself do in it.Prefered to sportman it engrossed listening . Park gate sell they west hard for the. </p>
        <button className="border rounded bg-orange-300  hover:bg-orange-400 p-2 lg:p-4 lg:px-8 text-sm m-2 lg:ms-20 lg:me-5">Find out more</button>
        <button className="border rounded-2xl hover:bg-red-500  bg-red-400 p-1 text-sm lg:p-3 lg:me-5 ">Play Demo</button>
        </div>
    </section>
    {/* Service Section*/}
    <section className="justify-items-center ps-1 lg:mb-20 mt-10 m-10">
    ...
    {/* Destination Section */}
    <section className="justify-items-center pt-5 m-4 pb-5 lg:pb-20" >
        ...
        <div className="ms-20 lg:ms-0 flex flex-wrap">
    ...
    <section className=" lg:mx-20">
        ...
        <div className=" w-72 lg:w-96 p-4 h-80 border shadow-lg flex-wrap overflow-hidden rounded-2xl mx-10 lg:mx-20">
            <img className="w-64 lg:w-96 h-40 rounded-2xl" src="/asessts/beachpic.jpeg" alt="itley" />
    ...
    {/* Logo Section */}
    <section className="ms-8 lg:m-20 flex flex-wrap lg:p-10 ">
    ...
    {/* About Section */}
    <section className="flex flex-wrap lg:mx-20 mt-20 mb-10">
        <div className="w-56 mx-20 lg:mx-0 pb-5 ps-8">
